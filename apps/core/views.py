...
# TODO: Implement a Django REST Framework ViewSet or APIView
# for managing BookLoan objects (list, create, update, delete, custom actions).
# This will replace the classic Django admin interface.
...
#     # Add any custom admin actions here
...
from apps.library.models import BookLoan, Student, Book
from apps.library.serializers import BookLoanSerializer, StudentSerializer, BookSerializer
...
class BookLoanAdminViewSet(viewsets.ModelViewSet):
    ...
    serializer_class = BookLoanSerializer
    # permission_classes = [IsAuthenticated]  # Commented out for development
